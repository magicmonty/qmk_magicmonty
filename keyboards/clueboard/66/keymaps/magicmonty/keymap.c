...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BL] = LAYOUT(
    ...
    KC_LCTL, KC_LGUI, KC_LALT,  _______, KC_SPC, KC_SPC, _______,      KC_RALT,  KC_RCTL,   MO_FUNC,    KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [_FL] = LAYOUT(
    ...
    SC_LSPO, _______, _______, _______, _______, _______, _______, _______, MEDIA,   _______, _______, _______, _______, SC_RSPC, KC_PGUP,
