...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [U_EXTRA] = LAYOUT_split_3x6_3(
    ...
    //|---------+--------------+--------------+--------------+--------------+-----------|                           |-----------+--------------+--------------+----------------+-----------------+---------|
       XXXXXXX,  KC_Y,          ALGR_T(KC_X),  KC_C,          KC_V,          KC_B,                                   KC_N,       KC_M,          KC_COMM,       ALGR_T(KC_DOT),  KC_SLSH,          XXXXXXX,
    //|---------+--------------+--------------+--------------+--------------+-----------+-----------|   |-----------+-----------+--------------+--------------+----------------+-----------------+---------|
                                                              U_MEDIA_ESC,   U_NAV_SPC,  KC_TAB,         U_SYM_ENT,  U_NUM_BSP,  U_FUN_DEL
                                                           //`--------------+-----------+-----------|   |-----------+-----------+--------------'
    ),
  ...
  [U_NAV] = LAYOUT_split_3x6_3(
    ...
    //|------------------+----------+---------+------------------+-----------------+---------|                      |---------+---------+---------+---------+---------+---------|
       XXXXXXX,           XXXXXXX,   KC_ALGR,  TD(U_TD_U_NUM),    TD(U_TD_U_NAV),   XXXXXXX,                         KC_INS,   KC_HOME,  KC_PGDN,  KC_PGUP,  KC_END,   XXXXXXX,
    //|------------------+----------+---------+------------------+-----------------+---------+---------|   |--------+---------+---------+---------+---------+---------+---------|
  ...
  [U_MEDIA] = LAYOUT_split_3x6_3(
    ...
    //|---------+---------+---------+------------------+------------------+---------|                       |---------+---------+---------+---------+---------+---------|
       XXXXXXX,  XXXXXXX,  KC_ALGR,  TD(U_TD_U_FUN),    TD(U_TD_U_MEDIA), XXXXXXX,                           OU_AUTO,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
    //|---------+---------+---------+------------------+------------------+---------+---------|   |---------+---------+---------+---------+---------+---------+---------|
  ...
  [U_NUM] = LAYOUT_split_3x6_3(
    //,---------+--------+------+------+--------+---------.                       ,---------+-----------------+------------------+---------+---------+--------------.
       XXXXXXX,  KC_LBRC, KC_7,  KC_8,  KC_9,    KC_RBRC,                          XXXXXXX,  TD(U_TD_U_BASE),  TD(U_TD_U_EXTRA),  XXXXXXX,  XXXXXXX,  TD(U_TD_BOOT),
    //|---------+--------+------+------+--------+---------|                       |---------+-----------------+------------------+---------+---------+--------------|
       XXXXXXX,  KC_SCLN, KC_4,  KC_5,  KC_6,    KC_EQL,                           XXXXXXX,  KC_LSFT,          KC_LCTL,           KC_LALT,  KC_LGUI,  XXXXXXX,
    //|---------+--------+------+------+--------+---------|                       |---------+-----------------+------------------+---------+---------+--------------|
       XXXXXXX, KC_GRV,   KC_1,  KC_2,  KC_3,    KC_BSLS,                          XXXXXXX,  TD(U_TD_U_NUM),   TD(U_TD_U_NAV),    KC_ALGR,  XXXXXXX,  XXXXXXX,
    //|---------+--------+------+------+--------+---------+---------|   |---------+---------+-----------------+------------------+---------+---------+--------------|
  ...
  [U_SYM] = LAYOUT_split_3x6_3(
    //,---------+---------+---------+---------+----------+----------.                       ,---------+-----------------+------------------+---------+---------+---------.
       XXXXXXX,  KC_LCBR,  KC_AMPR,  KC_ASTR,  KC_LPRN,   KC_RCBR,                           XXXXXXX,  TD(U_TD_U_BASE),  TD(U_TD_U_EXTRA),  XXXXXXX,  XXXXXXX,  XXXXXXX,
    //|---------+---------+---------+---------+----------+----------|                       |---------+-----------------+------------------+---------+---------+---------|
       XXXXXXX,  KC_COLN,  KC_DLR,   KC_PERC,  KC_CIRC,   KC_PLUS,                           XXXXXXX,  KC_LSFT,          KC_LCTL,           KC_LALT,  KC_LGUI,  XXXXXXX,
    //|---------+---------+---------+---------+----------+----------|                       |---------+-----------------+------------------+---------+---------+---------|
       XXXXXXX,  KC_TILD,  KC_EXLM,  KC_AT,    KC_HASH,   KC_PIPE,                           XXXXXXX,  TD(U_TD_U_SYM),   XXXXXXX,           KC_ALGR,  XXXXXXX,  XXXXXXX,
    //|---------+---------+---------+---------+----------+----------+---------|   |---------+---------+-----------------+------------------+---------+---------+---------|
