...
enum { TD_BASE, TD_MEDIA, TD_NAV, TD_SYM, TD_NUM, TD_FUN, TD_EXTRA, TD_BOOT };
...
void td_fn_MEDIA(tap_dance_state_t *state, void *user_data) {
  if (state->count == 2) {
    default_layer_set((layer_state_t)1 << U_MEDIA);
  }
}

void td_fn_NAV(tap_dance_state_t *state, void *user_data) {
  if (state->count == 2) {
    default_layer_set((layer_state_t)1 << U_NAV);
  }
}

void td_fn_SYM(tap_dance_state_t *state, void *user_data) {
  if (state->count == 2) {
    default_layer_set((layer_state_t)1 << U_SYM);
  }
}

void td_fn_NUM(tap_dance_state_t *state, void *user_data) {
  if (state->count == 2) {
    default_layer_set((layer_state_t)1 << U_NUM);
  }
}

void td_fn_FUN(tap_dance_state_t *state, void *user_data) {
  if (state->count == 2) {
...
tap_dance_action_t tap_dance_actions[] = {[TD_BASE] = ACTION_TAP_DANCE_FN(td_fn_BASE), [TD_MEDIA] = ACTION_TAP_DANCE_FN(td_fn_MEDIA), [TD_NAV] = ACTION_TAP_DANCE_FN(td_fn_NAV), [TD_SYM] = ACTION_TAP_DANCE_FN(td_fn_SYM), [TD_NUM] = ACTION_TAP_DANCE_FN(td_fn_NUM), [TD_FUN] = ACTION_TAP_DANCE_FN(td_fn_FUN), [TD_EXTRA] = ACTION_TAP_DANCE_FN(td_fn_EXTRA), [TD_BOOT] = ACTION_TAP_DANCE_FN(td_fn_BOOT)};
#define U_TD_BASE TD(TD_BASE)
#define U_TD_MEDIA TD(TD_MEDIA)
#define U_TD_NAV TD(TD_NAV)
#define U_TD_SYM TD(TD_SYM)
#define U_TD_NUM TD(TD_NUM)
#define U_TD_FUN TD(TD_FUN)
#define U_TD_EXTRA TD(TD_EXTRA)
#define U_TD_BOOT TD(TD_BOOT)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [U_BASE] = LAYOUT_split_3x6_3(
    ...
    //|---------+--------------+--------------+----------------+--------------+-----------+--------|   |-----------+-----------+--------------+--------------+---------------+--------------+---------|
                                                                MEDIA,         NAV_SPC,    KC_TAB,      SYM_ENT,    NUM_BSP,    FUN_DEL
                                                             //`--------------+-----------+--------|   |-----------+-----------+-------------'
  ),

  [U_MEDIA] = LAYOUT_split_3x6_3(
    //,---------+---------+---------+------------------+------------------+---------.                       ,---------+---------+---------+---------+---------+---------.
       XXXXXXX,  XXXXXXX,  XXXXXXX,  U_TD_EXTRA,        U_TD_BASE,         XXXXXXX,                          RGB_TOG,  XXXXXXX,  XXXXXXX,  XXXXXXX,  RGB_VAI,  KC_BSPC,
    //|---------+---------+---------+------------------+------------------+---------|                       |---------+---------+---------+---------+---------+---------|
       XXXXXXX,  KC_LGUI,  KC_LALT,  KC_LCTL,           KC_LSFT,           XXXXXXX,                          XXXXXXX,  KC_MPRV,  KC_MSTP,  XXXXXXX,  KC_MNXT,  XXXXXXX,
    //|---------+---------+---------+------------------+------------------+---------|                       |---------+---------+---------+---------+---------+---------|
       XXXXXXX,  XXXXXXX,  KC_ALGR,  U_TD_FUN,          U_TD_MEDIA,        XXXXXXX,                          XXXXXXX,  KC_MUTE,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_LGUI,
    //|---------+---------+---------+------------------+------------------+---------+---------|   |---------+---------+---------+---------+---------+---------+---------|
  ...
  [U_NAV] = LAYOUT_split_3x6_3(
    //,--------+--------------+---------+------------------+-----------------+---------.                      ,---------+---------+---------+---------+---------+---------.
       XXXXXXX, U_TD_BOOT,     XXXXXXX,  U_TD_EXTRA,        U_TD_BASE,        XXXXXXX,                         U_RDO,    U_PST,    U_CPY,    U_CUT,    U_UND,    KC_BSPC,
    //|--------+--------------+---------+------------------+-----------------+---------|                      |---------+---------+---------+---------+---------+---------|
       XXXXXXX, KC_LGUI,       KC_LALT,  KC_LCTL,           KC_LSFT,          XXXXXXX,                         CW_TOGG,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  XXXXXXX,
    //|--------+--------------+---------+------------------+-----------------+---------|                      |---------+---------+---------+---------+---------+---------|
       XXXXXXX, XXXXXXX,       KC_ALGR,  U_TD_NUM,          U_TD_NAV,         XXXXXXX,                         KC_INS,   KC_HOME,  KC_PGDN,  KC_PGUP,  KC_END,   KC_LGUI,
    //|--------+--------------+---------+------------------+-----------------+---------+---------|   |--------+---------+---------+---------+---------+---------+---------|
  ...
  [U_SYM] = LAYOUT_split_3x6_3(
    //,---------+---------+---------+---------+----------+----------.                       ,---------+-----------------+------------------+---------+---------+---------.
       DE_MINS,  DE_PLUS,  DE_AMPR,  DE_ASTR,  DE_QUES,   DE_LBRC,                           DE_RBRC,  U_TD_BASE,        U_TD_EXTRA,        XXXXXXX,  XXXXXXX,  KC_BSPC,
    //|---------+---------+---------+---------+----------+----------|                       |---------+-----------------+------------------+---------+---------+---------|
       XXXXXXX,  DE_COLN,  DE_DLR,   DE_PERC,  DE_CIRC,   DE_LCBR,                           DE_RCBR,  KC_LSFT,          KC_LCTL,           KC_LALT,  KC_LGUI,  XXXXXXX,
    //|---------+---------+---------+---------+----------+----------|                       |---------+-----------------+------------------+---------+---------+---------|
       XXXXXXX,  DE_TILD,  DE_EXLM,  DE_AT,    DE_HASH,   DE_LPRN,                           DE_RPRN,  U_TD_SYM,         XXXXXXX,           KC_ALGR,  XXXXXXX,  KC_LGUI,
    //|---------+---------+---------+---------+----------+----------+---------|   |---------+---------+-----------------+------------------+---------+---------+---------|
  ...
  [U_NUM] = LAYOUT_split_3x6_3(
    //,---------+--------+------+------+--------+---------.                       ,---------+-----------------+------------------+---------+--------------+--------------.
       XXXXXXX,  XXXXXXX, KC_7,  KC_8,  KC_9,    DE_QUOT,                          DE_DQUO,  U_TD_BASE,        U_TD_EXTRA,  XXXXXXX,        U_TD_BOOT,     KC_BSPC ,
    //|---------+--------+------+------+--------+---------|                       |---------+-----------------+------------------+---------+--------------+--------------|
       XXXXXXX,  DE_SCLN, KC_4,  KC_5,  KC_6,    DE_EQL,                           XXXXXXX,  KC_LSFT,          KC_LCTL,           KC_LALT,  KC_LGUI,       XXXXXXX,
    //|---------+--------+------+------+--------+---------|                       |---------+-----------------+------------------+---------+--------------+--------------|
       XXXXXXX,  DE_GRV,  KC_1,  KC_2,  KC_3,    DE_BSLS,                          XXXXXXX,  U_TD_NUM,         U_TD_NAV,          KC_ALGR,  XXXXXXX,       KC_LGUI,
    //|---------+--------+------+------+--------+---------+---------|   |---------+---------+-----------------+------------------+---------+--------------+--------------|
  ...
  [U_FUN] = LAYOUT_split_3x6_3(
    //,---------+--------+-------+-------+--------+---------.                      ,---------+-----------------+------------------+---------+---------+---------.
       XXXXXXX,  KC_F12,  KC_F7,  KC_F8,  KC_F9,   KC_PSCR,                         XXXXXXX,  U_TD_BASE,        U_TD_EXTRA,        XXXXXXX,  XXXXXXX,  KC_BSPC,
    //|---------+--------+-------+-------+--------+---------|                      |---------+-----------------+------------------+---------+---------+---------|
       XXXXXXX,  KC_F11,  KC_F4,  KC_F5,  KC_F6,   KC_SCRL,                         XXXXXXX,  KC_LSFT,          KC_LCTL,           KC_LALT,  XXXXXXX,  XXXXXXX,
    //|---------+--------+-------+-------+--------+---------|                      |---------+-----------------+------------------+---------+---------+---------|
       XXXXXXX,  KC_F10,  KC_F1,  KC_F2,  KC_F3,   KC_PAUS,                         XXXXXXX,  U_TD_FUN,         U_TD_MEDIA,        KC_ALGR,  XXXXXXX,  KC_LGUI,
    //|---------+--------+-------+-------+--------+---------+--------|   |---------+---------+-----------------+------------------+---------+---------+---------|
