...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [U_BASE] = LAYOUT_split_3x6_3(
    ...
    //|---------+--------------+--------------+----------------+--------------+-----------|                        |-----------+--------------+--------------+---------------+--------------+---------|
       XXXXXXX,  KC_A,          LALT_T(KC_S),  LCTL_T(KC_R),    LSFT_T(KC_T),  KC_G,                                KC_F,       LSFT_T(KC_N),  LCTL_T(KC_E),  LALT_T(KC_I),   KC_O,          KC_J,
    //|---------+--------------+--------------+----------------+--------------+-----------|                        |-----------+--------------+--------------+---------------+--------------+---------|
       KC_MINS,  KC_QUOT,       ALGR_T(KC_Y),  KC_X,            KC_C,          KC_V,                                KC_B,       KC_H,          KC_COMM,       ALGR_T(KC_DOT), DE_SLSH,       KC_LGUI,
    //|---------+--------------+--------------+----------------+--------------+-----------+--------|   |-----------+-----------+--------------+--------------+---------------+--------------+---------|
  ...
  [U_NAV] = LAYOUT_split_3x6_3(
    //,------------------+----------+---------+------------------+-----------------+---------.                      ,---------+---------+---------+---------+---------+---------.
       TD(U_TD_BOOT),     XXXXXXX,   XXXXXXX,  TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),  XXXXXXX,                         U_RDO,    U_PST,    U_CPY,    U_CUT,    U_UND,    XXXXXXX,
    //|------------------+----------+---------+------------------+-----------------+---------|                      |---------+---------+---------+---------+---------+---------|
       XXXXXXX,           KC_LGUI,   KC_LALT,  KC_LCTL,           KC_LSFT,          XXXXXXX,                         CW_TOGG,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  XXXXXXX,
    //|------------------+----------+---------+------------------+-----------------+---------|                      |---------+---------+---------+---------+---------+---------|
       XXXXXXX,           XXXXXXX,   KC_ALGR,  TD(U_TD_U_NUM),    TD(U_TD_U_NAV),   XXXXXXX,                         KC_INS,   KC_HOME,  KC_PGDN,  KC_PGUP,  KC_END,   _______,
    //|------------------+----------+---------+------------------+-----------------+---------+---------|   |--------+---------+---------+---------+---------+---------+---------|
  ...
  [U_MEDIA] = LAYOUT_split_3x6_3(
    //,---------+---------+---------+------------------+------------------+---------.                       ,---------+---------+---------+---------+---------+---------.
       XXXXXXX,  XXXXXXX,  XXXXXXX,  TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   XXXXXXX,                          RGB_TOG,  RGB_MOD,  RGB_HUI,  RGB_SAI,  RGB_VAI,  XXXXXXX,
    //|---------+---------+---------+------------------+------------------+---------|                       |---------+---------+---------+---------+---------+---------|
       XXXXXXX,  KC_LGUI,  KC_LALT,  KC_LCTL,           KC_LSFT,           XXXXXXX,                          XXXXXXX,  KC_MPRV,  KC_VOLD,  KC_VOLU,  KC_MNXT,  XXXXXXX,
    //|---------+---------+---------+------------------+------------------+---------|                       |---------+---------+---------+---------+---------+---------|
       XXXXXXX,  XXXXXXX,  KC_ALGR,  TD(U_TD_U_FUN),    TD(U_TD_U_MEDIA), XXXXXXX,                           OU_AUTO,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  _______,
    //|---------+---------+---------+------------------+------------------+---------+---------|   |---------+---------+---------+---------+---------+---------+---------|
  ...
  [U_NUM] = LAYOUT_split_3x6_3(
    //,---------+--------+------+------+--------+---------.                       ,---------+-----------------+------------------+---------+---------+--------------.
       XXXXXXX,  DE_LBRC, KC_7,  KC_8,  KC_9,    DE_RBRC,                          XXXXXXX,  TD(U_TD_U_BASE),  TD(U_TD_U_EXTRA),  XXXXXXX,  XXXXXXX,  TD(U_TD_BOOT),
    //|---------+--------+------+------+--------+---------|                       |---------+-----------------+------------------+---------+---------+--------------|
       XXXXXXX,  DE_SCLN, KC_4,  KC_5,  KC_6,    DE_EQL,                           XXXXXXX,  KC_LSFT,          KC_LCTL,           KC_LALT,  XXXXXXX,  XXXXXXX,
    //|---------+--------+------+------+--------+---------|                       |---------+-----------------+------------------+---------+---------+--------------|
       XXXXXXX,  DE_GRV,  KC_1,  KC_2,  KC_3,    DE_BSLS,                          XXXXXXX,  TD(U_TD_U_NUM),   TD(U_TD_U_NAV),    KC_ALGR,  XXXXXXX,  _______,
    //|---------+--------+------+------+--------+---------+---------|   |---------+---------+-----------------+------------------+---------+---------+--------------|
  ...
  [U_SYM] = LAYOUT_split_3x6_3(
    //,---------+---------+---------+---------+----------+----------.                       ,---------+-----------------+------------------+---------+---------+---------.
       XXXXXXX,  DE_LCBR,  DE_AMPR,  DE_ASTR,  DE_MINS,   DE_RCBR,                           XXXXXXX,  TD(U_TD_U_BASE),  TD(U_TD_U_EXTRA),  XXXXXXX,  XXXXXXX,  KC_BSPC,
    //|---------+---------+---------+---------+----------+----------|                       |---------+-----------------+------------------+---------+---------+---------|
       XXXXXXX,  DE_COLN,  DE_DLR,   DE_PERC,  DE_CIRC,   DE_PLUS,                           XXXXXXX,  KC_LSFT,          KC_LCTL,           KC_LALT,  XXXXXXX,  XXXXXXX,
    //|---------+---------+---------+---------+----------+----------|                       |---------+-----------------+------------------+---------+---------+---------|
       XXXXXXX,  DE_TILD,  DE_EXLM,  DE_AT,    DE_HASH,   DE_PIPE,                           XXXXXXX,  TD(U_TD_U_SYM),   XXXXXXX,           KC_ALGR,  XXXXXXX,  _______,
    //|---------+---------+---------+---------+----------+----------+---------|   |---------+---------+-----------------+------------------+---------+---------+---------|
                                               DE_UNDS,   DE_LPRN,   DE_RPRN,      XXXXXXX,  XXXXXXX,  XXXXXXX
                                            //`----------+----------+---------|   |---------+---------+-----------------'
    ),

  [U_FUN] = LAYOUT_split_3x6_3(
    //,---------+--------+-------+-------+--------+---------.                      ,---------+-----------------+------------------+---------+---------+---------.
       XXXXXXX,  KC_F12,  KC_F7,  KC_F8,  KC_F9,   KC_PSCR,                         XXXXXXX,  TD(U_TD_U_BASE),  TD(U_TD_U_EXTRA),  XXXXXXX,  XXXXXXX,  XXXXXXX,
    //|---------+--------+-------+-------+--------+---------|                      |---------+-----------------+------------------+---------+---------+---------|
       XXXXXXX,  KC_F11,  KC_F4,  KC_F5,  KC_F6,   KC_SCRL,                         XXXXXXX,  KC_LSFT,          KC_LCTL,           KC_LALT,  XXXXXXX,  XXXXXXX,
    //|---------+--------+-------+-------+--------+---------|                      |---------+-----------------+------------------+---------+---------+---------|
       XXXXXXX,  KC_F10,  KC_F1,  KC_F2,  KC_F3,   KC_PAUS,                         XXXXXXX,  TD(U_TD_U_FUN),   TD(U_TD_U_MEDIA),  KC_ALGR,  XXXXXXX,  _______,
    //|---------+--------+-------+-------+--------+---------+--------|   |---------+---------+-----------------+------------------+---------+---------+---------|
